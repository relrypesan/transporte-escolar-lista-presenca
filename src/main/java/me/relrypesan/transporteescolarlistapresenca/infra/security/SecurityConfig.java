    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(amrmr -> amrmr
                        ...
                        .mvcMatchers(HttpMethod.POST, "/usuarios").hasRole(PermissoesEnum.ADMIN_MASTER.name())
                        .mvcMatchers(HttpMethod.PATCH, "/usuarios/**").hasRole(PermissoesEnum.ADMIN_MASTER.name())
